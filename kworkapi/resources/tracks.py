...
class TracksResource(Resource):
    ...
    async def search(self, text: str, order_id: int, *, page: int = 1) -> dict:
    ...
    async def edit(self, track_id: int, text: str, *, quote_id: int | None = None) -> dict:
    ...
    async def read(self, ids: Sequence[int]) -> dict:
